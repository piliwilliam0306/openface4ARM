...
class AlignDlib:
    ...
    def getAllFaceBoundingBoxes(self, rgbImg):
    	...
    	'''
	    #print("Found {0} faces!".format(len(faces_found)))
	    #return faces_found	
	    #use dlib
    ...
    def motionDetect(self, gray, lastFrame):
	"""
	:param gray: gray image to process
	:param lastFrame: gray image from last frame
	:return: Average Area of detected
	"""
